...
@Component
@Slf4j
public class JavaDockerSandbox extends SandboxTemplate {
    private final long memoryLimit = 128 * 1024 * 1024;
    private final long cpuCount = 1;
    private final String savePath = System.getProperty("user.dir") + File.separator + "tmpCode";
    private final String memScript = System.getProperty("user.dir") + File.separator + "script" + File.separator + "mem.sh";
    private final String jdkImage = "openjdk:17";

    @Resource
    private DockerClient dockerClient;

    @Override
    protected ExecuteCodeResponse compileAndRun(File codeFile, List<String> inputList)
